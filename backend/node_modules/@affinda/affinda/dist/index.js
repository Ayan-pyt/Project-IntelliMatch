...
(function (KnownAnnotationContentType) {
    ...
    /** Docclf */
    KnownAnnotationContentType["Docclf"] = "docclf";
...
(function (KnownResumeDataLanguagesItem) {
    ...
    /** BahasaIndonesian */
    KnownResumeDataLanguagesItem["BahasaIndonesian"] = "Bahasa Indonesian";
    /** Bambara */
...
(function (KnownEnum17) {
    /** Resumes */
    KnownEnum17["Resumes"] = "resumes";
    /** JobDescriptions */
    KnownEnum17["JobDescriptions"] = "job_descriptions";
})(exports.KnownEnum17 || (exports.KnownEnum17 = {}));
/** Known values of {@link IndexDocType} that the service accepts. */
exports.KnownIndexDocType = void 0;
(function (KnownIndexDocType) {
    /** Resumes */
    KnownIndexDocType["Resumes"] = "resumes";
    /** JobDescriptions */
    KnownIndexDocType["JobDescriptions"] = "job_descriptions";
})(exports.KnownIndexDocType || (exports.KnownIndexDocType = {}));
/** Known values of {@link DocType} that the service accepts. */
exports.KnownDocType = void 0;
(function (KnownDocType) {
    /** Resumes */
    KnownDocType["Resumes"] = "resumes";
    /** JobDescriptions */
    KnownDocType["JobDescriptions"] = "job_descriptions";
})(exports.KnownDocType || (exports.KnownDocType = {}));
...
(function (KnownDocumentSplitterType) {
    ...
    /** Keyword */
    KnownDocumentSplitterType["Keyword"] = "keyword";
...
const DocumentCreateFromDataData = {
    type: {
        name: "Composite",
        className: "DocumentCreateFromDataData",
    },
...
var Mappers = /*#__PURE__*/Object.freeze({
    ...
    PydanticModelsResponse: PydanticModelsResponse,
    ...
    DocumentCreateFromData: DocumentCreateFromData,
    DocumentCreateFromDataData: DocumentCreateFromDataData,
...
const body4 = {
    parameterPath: "body",
    mapper: DocumentTypeCreate,
};
const body5 = {
    parameterPath: "body",
    mapper: DocumentTypeUpdate,
};
const title = {
...
class AffindaAPI extends coreClient__namespace.ServiceClient {
     ...
     * @param options The options parameters.
     */
    getRedactedDocument(identifier, options) {
        return this.sendOperationRequest({ identifier, options }, getRedactedDocumentOperationSpec);
    }
    /**
    ...
    getDocumentTypes(options) {
        return this.sendOperationRequest({ options }, getDocumentTypesOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    createDocumentType(body, options) {
        return this.sendOperationRequest({ body, options }, createDocumentTypeOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    getDocumentType(identifier, options) {
        return this.sendOperationRequest({ identifier, options }, getDocumentTypeOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    updateDocumentType(identifier, body, options) {
        return this.sendOperationRequest({ identifier, body, options }, updateDocumentTypeOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    deleteDocumentType(identifier, options) {
        return this.sendOperationRequest({ identifier, options }, deleteDocumentTypeOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    jsonSchemaFromDocumentType(identifier, options) {
        return this.sendOperationRequest({ identifier, options }, jsonSchemaFromDocumentTypeOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    pydanticModelsFromDocumentType(identifier, options) {
        return this.sendOperationRequest({ identifier, options }, pydanticModelsFromDocumentTypeOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    updateMappingDataSourceValue(identifier, value, body, options) {
        return this.sendOperationRequest({ identifier, value, body, options }, updateMappingDataSourceValueOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    createDocumentFromData(body, options) {
        return this.sendOperationRequest({ body, options }, createDocumentFromDataOperationSpec);
    }
    /**
...
const getDocumentOperationSpec = {
    ...
    urlParameters: [region, identifier1],
    headerParameters: [accept],
    serializer,
};
const updateDocumentOperationSpec = {
    ...
    requestBody: body,
    queryParameters: [compact, snakeCase],
    urlParameters: [region, identifier1],
...
const getRedactedDocumentOperationSpec = {
...
const getDocumentTypesOperationSpec = {
    ...
    queryParameters: [workspace, organization1],
    urlParameters: [region],
    headerParameters: [accept],
    serializer,
};
const createDocumentTypeOperationSpec = {
    path: "/v3/document_types",
    httpMethod: "POST",
    responses: {
        201: {
            bodyMapper: DocumentType,
        },
        400: {
            bodyMapper: RequestError,
            isError: true,
...
const getDocumentTypeOperationSpec = {
...
const updateDocumentTypeOperationSpec = {
    path: "/v3/document_types/{identifier}",
    httpMethod: "PATCH",
    responses: {
        200: {
...
const deleteDocumentTypeOperationSpec = {
    path: "/v3/document_types/{identifier}",
    httpMethod: "DELETE",
    responses: {
        204: {},
...
const jsonSchemaFromDocumentTypeOperationSpec = {
...
const pydanticModelsFromDocumentTypeOperationSpec = {
    path: "/v3/document_types/{identifier}/pydantic_models",
    httpMethod: "GET",
    responses: {
        200: {
            bodyMapper: PydanticModelsResponse,
        },
        400: {
            bodyMapper: RequestError,
            isError: true,
...
const getMappingDataSourceValueOperationSpec = {
    ...
    urlParameters: [region, identifier1, value],
    headerParameters: [accept],
    serializer,
};
const updateMappingDataSourceValueOperationSpec = {
    path: "/v3/mapping_data_sources/{identifier}/values/{value}",
    httpMethod: "PUT",
    responses: {
        200: {
...
const getAllValidationResultsOperationSpec = {
    ...
    queryParameters: [offset, limit, document1],
    urlParameters: [region],
    headerParameters: [accept],
    serializer,
};
...
const createDocumentFromDataOperationSpec = {
...
const deleteIndexDocumentOperationSpec = {
    ...
    urlParameters: [region, identifier1, name3],
    headerParameters: [accept],
    serializer,
};
