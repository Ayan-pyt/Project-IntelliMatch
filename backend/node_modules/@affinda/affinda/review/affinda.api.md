...
// @public
export interface CreateDocumentFromDataOptionalParams extends coreClient.OperationOptions {
    snakeCase?: boolean;
}
...
// @public
export interface CreateDocumentTypeOptionalParams extends coreClient.OperationOptions {
}

// @public
export type CreateDocumentTypeResponse = DocumentType_2;
...
// @public
export interface DeleteDocumentTypeOptionalParams extends coreClient.OperationOptions {
}
...
// @public (undocumented)
export type DocumentUnion = Document_2 | Resume | Invoice | JobDescription | ResumeRedact;
...
// @public
export interface GetDocumentTypeOptionalParams extends coreClient.OperationOptions {
}

// @public
export type GetDocumentTypeResponse = DocumentType_2;

// @public
export interface GetDocumentTypesOptionalParams extends coreClient.OperationOptions {
    organization?: string;
    workspace?: string;
}

// @public
export type GetDocumentTypesResponse = DocumentType_2[];
...
// @public
export interface GetRedactedDocumentOptionalParams extends coreClient.OperationOptions {
}
...
// @public (undocumented)
export interface Invoice extends Document_2 {
    // (undocumented)
    data?: InvoiceData;
    extractor: "invoice";
}
...
// @public (undocumented)
export interface JobDescription extends Document_2 {
...
// @public (undocumented)
export interface JobDescriptionSearchDetailLocationValue extends Location_2, Components1TlnsonSchemasJobdescriptionsearchdetailPropertiesLocationPropertiesValueAllof1 {
}
...
// @public
export interface JsonSchemaFromDocumentTypeOptionalParams extends coreClient.OperationOptions {
    title?: string;
}
...
// @public (undocumented)
export interface LocationAnnotationUpdateParsed extends Location_2 {
}
...
// @public
export interface PydanticModelsFromDocumentTypeOptionalParams extends coreClient.OperationOptions {
    modelName?: string;
}
...
// @public (undocumented)
export interface Resume extends Document_2 {
    data?: ResumeData;
    extractor: "resume";
}
...
// @public (undocumented)
export interface ResumeRedact extends Document_2 {
    // (undocumented)
...
// @public (undocumented)
export interface ResumeSearchDetailLocationValue extends Location_2, ComponentsN9ShogSchemasResumesearchdetailPropertiesLocationPropertiesValueAllof1 {
}
...
// @public
export interface UpdateDocumentTypeOptionalParams extends coreClient.OperationOptions {
}

// @public
export type UpdateDocumentTypeResponse = DocumentType_2;
...
// @public
export interface UpdateMappingDataSourceValueOptionalParams extends coreClient.OperationOptions {
}
